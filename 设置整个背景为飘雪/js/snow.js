...
(function (e, t, n) {
    ...
    function o(e, t, n, r, i, s) {
        ...
        if (o[0].toString().indexOf("%") !== -1) l = parseFloat(o[0]) / 100, a = n.width * l, e !== "backgroundSize" && (a -= (s || r).width * l); else if (e === "backgroundSize") if (o[0] === "auto") a = r.width; else if (/contain|cover/.test(o[0])) {
            var h = f.Util.resizeBounds(r.width, r.height, n.width, n.height, o[0]);
            a = h.width, u = h.height
        } else a = parseInt(o[0], 10); else a = parseInt(o[0], 10);
    ...
    function u(e, t) {
        ...
        return {
            storage: n, width: e, height: t, clip: function () {
                ...
                var e = [];
                return n.push({type: "function", name: "drawShape", arguments: e}), {
                    moveTo: function () {
                ...
                return n.push({type: "variable", name: e, arguments: t}), t
            }
        }
    }
    ...
    f.Util = {}, f.Util.log = function (t) {
        ...
        var e = /((rgba|rgb)\([^\)]+\)(\s-?\d+px){0,})/g, t = /(-?\d+px)|(#.+)|(rgb\(.+\))|(rgba\(.+\))/g;
        ...
        var t = e.offsetParent ? f.Util.OffsetBounds(e.offsetParent) : {top: 0, left: 0};
        return {
        ...
        try {
            t = e.nodeName && e.nodeName.toUpperCase() === "IFRAME" ? e.contentDocument || e.contentWindow.document : function (e) {
                ...
                return e !== null && function (e, t) {
                    var r = e.length, i = 0;
                    if (typeof t.length == "number") for (var s = t.length; i < s; i++) e[r++] = t[i]; else while (t[i] !== n) e[r++] = t[i++];
                    return e.length = r, e
                }(t, e), t
            }(e.childNodes)
        } catch (r) {
        ...
        return function (t, r, i) {
            ...
            var s = i.createElement("div"), o = i.createElement("img"), u = i.createElement("span"), a = "Hidden Text",
                f, l, c;
        ...
        r.parseGradient = function (e, t) {
            ...
            if (o) switch (o.type) {
                ...
                case"circle":
                    ...
                    break;
                case"ellipse":
                    var a = t.createElement("canvas"), l = a.getContext("2d"), c = Math.max(o.rx, o.ry), h = c * 2;
            ...
            var t = ["M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"],
                n = [1e3, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1], r = "", i, s = t.length;
            if (e <= 0 || e >= 4e3) return e;
            for (i = 0; i < s; i += 1) while (e >= n[i]) e -= n[i], r += t[i];
            return r
        }
        ...
        function m(e, t, n, r) {
            var i = !1, s = vt(t, "fontWeight"), o = vt(t, "fontFamily"), u = vt(t, "fontSize"),
        ...
        function E(e, t, n) {
            var r = n.ctx, s = vt(e, "color"), o = vt(e, "textDecoration"), u = vt(e, "textAlign"), a, f,
                l = {node: t, textOffset: 0};
        ...
        function k(e, t) {
            var n = Math.max(e.left, t.left), r = Math.max(e.top, t.top),
                i = Math.min(e.left + e.width, t.left + t.width), s = Math.min(e.top + e.height, t.top + t.height);
            return {left: n, top: r, width: i - n, height: s - r}
        }

        function L(e, t, n) {
            var r, i = t.cssPosition !== "static", s = i ? vt(e, "zIndex") : "auto", o = vt(e, "opacity"),
        ...
        function O(e) {
            return ["Top", "Right", "Bottom", "Left"].map(function (t) {
                return {width: l(e, "border" + t + "Width"), color: vt(e, "border" + t + "Color")}
            })
        }
        ...
        function H(e, t, n) {
            var r = e.left, i = e.top, s = e.width, o = e.height, u = t[0][0], a = t[0][1], f = t[1][0], l = t[1][1],
                c = t[2][0], h = t[2][1], p = t[3][0], d = t[3][1], v = s - f, m = o - h, g = s - c, y = o - d;
            return {
        ...
        function j(e, t, n) {
            var r = t.left, i = t.top, s = t.width, o = t.height, u, a, f, l, c, h, p = M(e), d = H(t, p, n),
                v = {clip: B(e, d, n, p, t), borders: []};
            for (u = 0; u < 4; u++) if (n[u].width > 0) {
                ...
                v.borders.push({args: h, color: n[u].color})
            }
            return v
        }
        ...
        function J(e, t, n, r, i) {
            var s = ct.BackgroundSize(e, t, r, i), o = ct.BackgroundPosition(e, t, r, i, s),
            ...
            switch (u) {
                ...
                case"no-repeat":
                    ...
                    break;
                default:
                    X(n, r, o, {top: t.top, left: t.left, width: r.width, height: r.height})
            }
        }
        ...
        function rt(e, t, n, r) {
            var i = Z(e, t), s = nt(e, i), o, u = et(e, t, s, i), a = u.borders, f = u.ctx, l = tt(a, s, u.clip),
                c = j(e, s, a), h = pt.test(e.nodeName) ? "#efefef" : vt(e, "backgroundColor");
        ...
        function ut() {
            var e = vt(t.documentElement, "backgroundColor"), n = ct.isTransparent(e) && at === t.body,
                r = rt(at, null, !1, n);
            return ot(at, r), n && (e = r.backgroundColor), dt.removeChild(gt), {backgroundColor: e, stack: r}
        }

        e.scroll(0, 0);
        var at = i.elements === n ? t.body : i.elements[0], ft = 0, lt = at.ownerDocument, ct = f.Util,
            ht = ct.Support(i, lt), pt = new RegExp("(" + i.ignoreElements + ")"), dt = lt.body, vt = ct.getCSS,
            mt = "___html2canvas___pseudoelement", gt = lt.createElement("style");
        ...
        var yt = function (e) {
            return function (t, n, r, i) {
                ...
                return {
                    topLeft: _({x: t, y: a}, {x: t, y: a - o}, {x: u - s, y: n}, {x: u, y: n}),
                    topRight: _({x: t, y: n}, {x: t + s, y: n}, {x: u, y: a - o}, {x: u, y: a}),
                    bottomRight: _({x: u, y: n}, {x: u, y: n + o}, {x: t + s, y: a}, {x: t, y: a}),
                    bottomLeft: _({x: u, y: a}, {x: u - s, y: a}, {x: t, y: n + o}, {x: t, y: n})
                }
            }
        ...
        function l(e, t) {
            ...
            r !== n && (v[e] = {img: r, succeeded: !0}, v.numTotal++, v.numLoaded++, s())
        }
        ...
        var v = {numLoaded: 0, numFailed: 0, numTotal: 0, cleanupDone: !1}, m, g = f.Util, y, b, w = 0,
            E = r.elements[0] || t.body, S = E.ownerDocument, x = E.getElementsByTagName("img"), T = x.length,
            N = S.createElement("a"), C = function (e) {
                return e.crossOrigin !== n
            }(new Image), k;
        N.href = e.location.href, m = N.protocol + N.host, y = {
            loadImage: function (e) {
                var t, s;
                e && v[e] === n && (t = new Image, e.match(/data:image\/.*;base64,/i) ? (t.src = e.replace(/url\(['"]{0,}|['"]{0,}\)$/ig, ""), s = v[e] = {img: t}, v.numTotal++, d(t, s)) : i(e) || r.allowTaint === !0 ? (s = v[e] = {img: t}, v.numTotal++, d(t, s), t.src = e) : C && !r.allowTaint && r.useCORS ? (t.crossOrigin = "anonymous", s = v[e] = {img: t}, v.numTotal++, d(t, s), t.src = e) : r.proxy && (s = v[e] = {img: t}, v.numTotal++, o(e, t, s)))
        ...
        function i(e) {
            ...
            return i = function (e) {
                function t(e, r, i) {
                    var s = r.zIndex.zindex === "auto" ? 0 : Number(r.zIndex.zindex), o = e, u = r.zIndex.isPositioned,
                        a = r.zIndex.isFloated, f = {node: r}, l = i;
                    if (r.zIndex.ownStacking) o = f.context = {
                        "!": [{
                            node: r,
                            children: []
                        }]
                    }, l = n; else if (u || a) l = f.children = [];
                    s === 0 && i ? i.push(f) : (e[s] || (e[s] = []), e[s].push(f)), r.zIndex.children.forEach
                    (function (e) {
                        t(o, e, l)
                    })
                }
        ...
        function s(e) {
            var t;
            if (typeof r.renderer == "string" && f.Renderer[e] !== n) t = f.Renderer[e](r); else {
        ...
        return {rangeBounds: i(), svgRendering: e.svgRendering && r()}
    ...
    }, e.html2canvas.log = f.Util.log, e.html2canvas.Renderer = {Canvas: n}, f.Renderer.Canvas = function (e) {
        function r(e, t) {
        ...
        e = e || {};
        var o = t, u = [], a = t.createElement("canvas"), l = a.getContext("2d"), c = f.Util,
...
var detectEdge = function () {
    function e(e, t, s) {
        var o = n.createImageData(r, i), u = e.width, a = e.height, f = e.data, l = o.data, c = u * 4, h = c + 4,
            p = a - 1, d = u - 1, v = new Date;
        for (var m = 1; m < p; ++m) {
            var g = h - 4, y = g - c, b = g + c, w = -f[y] - f[g] - f[b], E = -f[++y] - f[++g] - f[++b],
                S = -f[++y] - f[++g] - f[++b], x = f[y += 2], T = f[g += 2], N = f[b += 2], C = -x - T - N, k = f[++y],
                L = f[++g], A = f[++b], O = -k - L - A, M = f[++y], _ = f[++g], D = f[++b], P = -M - _ - D;
            for (var H = 1; H < d; ++H) {
                g = h + 4, y = g - c, b = g + c;
    ...
    function t(t) {
        ...
        for (var u = 0; u < r; ++u) for (var a = 0; a < n; ++a) s[o] < 240 ? (s[o] = 0, s[++o] = 0, s[++o] = 0) : (s[o] = 255, s[++o] = 255, s[++o] = 255), s[++o] = 255, ++o;
        return i
    }
    ...
    return function (e) {
        ...
        return n.putImageData(a, 0, 0), {dropPoints: s, dropCount: o, cw: r, ch: i}
    }
}();
Animation = function () {
    "use strict";
    ...
    var i, s, o = 16.7, u;
    return {addFrameRenderer: e, start: r}
}(), Snowflakes = function () {
    "use strict";
    ...
    function s(t) {
        var n = "position:fixed;left:0;top:0;z-index:100001;pointer-events: none;";
        var sn = "position:fixed;left:0;top:0;z-index:100001;pointer-events: none;  ";
        v.width = t.cw, v.height = t.ch, e(t.flakeCount), D = document.createElement("canvas"), H = document.createElement("canvas"), D.style.cssText = n, H.style.cssText = sn, document.body.appendChild(D), document.body.appendChild(H), P = D.getContext("2d"), B = H.getContext("2d"), D.width = H.width = t.cw, D.height = H.height = t.ch, j = t.dropPoints, F = t.dropCount, I = t.maxPointDrop, Animation.addFrameRenderer(i, B), Animation.start()
    }

    var o = [], u = 1, a = .1, f = 2, l = "http://p8.qhimg.com/d/inn/43158a81/Snowflakes.png", c = [], h = 5, p = 20,
        d = 20, v = {}, m = 1, g = 4, y = -1, b = 3, w = .2, E = 1.25, S = 2, x = 3, T = .2, N = .9, C = 50, k = 60,
        L = 0, A = 1, O = .1, M = 1.5, _ = .05, D, P, H, B, j, F, I;
    return {init: s}
